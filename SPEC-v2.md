> **FROZEN — UVS v2 archive.** This document is the original v2 monolith, retained **unchanged** for existing deployments. New work targets **v3**, which is split into three documents: **UVS-core** (`uvs.md`), **uvGame Standard** (`uvGs.md`), and **uvLottery Standard** (`uvLs.md`). The v3 index is `SPEC.md`. The v1 archive is `SPEC-v1.md`.
